...
2. The **t-distribution** (denoted $t(df)$) depends on one parameter, $df$, and has a mean of 0 and a standard deviation of $\frac{df}{df-1}$. Again $df$ stands for "degrees of freedom," which are given for particular statistics (e.g. $df = n - 1$)
