...
author: "Chester Ismay, Albert Y. Kim, Arend M. Kuyper, Elizabeth Tipton, and Kaitlyn Fitzgerald"
...
url: 'https\://nulib.github.io/moderndive_book/'
...
needed_CRAN_pkgs <- c(
  # Data packages:
  "nycflights13", "ggplot2movies", "fivethirtyeight", "gapminder", "ISLR", "dslabs",
...
**Please note that this is a "development version" of ModernDive for the new design of STAT 202. Meaning this is a work in progress being edited and updated as we go.**
```
...
This is version `r version` of ModernDive published on `r date`. For previous versions of ModernDive, see the "About this book" section below.
