...
sx2 <- var(evals_ch5$bty_avg)
sy2 <- var(evals_ch5$score)
n <- dim(evals_ch5)[1]

Syy <- (n-1)*sy2
Sxy <- (n-1)*cov(evals_ch5$bty_avg, evals_ch5$score)
Sxx <- (n-1)*sx2
SSE <- Syy - Sxy^2/Sxx
MSE <- SSE / (n-2)
